...
<input type="button" value="view  posts" name="LoginUser">
<p>we also have an online noticeboard for our office where you can check our updates</p>
<a href="noticeboardsecurity.php"> <input type="button" value="notice board" name="LoginUser"><br></a>
<p>to  exit the office board room click the log out button to leave no traces</p>
<input type="button" value="log out" name="LoginUser" >
</body>
</body>
</html>